...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6107485602656807444L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"be.anthares\",\"fields\":[{\"name\":\"message\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Greeting(java.lang.String message) {
   ...
   */
  public static be.anthares.Greeting.Builder newBuilder() {
    return new be.anthares.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static be.anthares.Greeting.Builder newBuilder(be.anthares.Greeting.Builder other) {
    if (other == null) {
      return new be.anthares.Greeting.Builder();
    } else {
      return new be.anthares.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static be.anthares.Greeting.Builder newBuilder(be.anthares.Greeting other) {
    if (other == null) {
      return new be.anthares.Greeting.Builder();
    } else {
      return new be.anthares.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(be.anthares.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(be.anthares.Greeting other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.message)) {
        this.message = data().deepCopy(fields()[0].schema(), other.message);
    ...
    /**
      ...
      * @return This builder.
      */
    public be.anthares.Greeting.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public be.anthares.Greeting.Builder clearMessage() {
      message = null;
